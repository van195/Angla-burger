...
import { CreateAccount, createAdminUser, dashboardStats, getAllUsers, getSingleUsers, loginAdminUser } from '../controller/userController.js';
...
router
   ...
   .post('/loginAdmin-user',loginAdminUser)
